...
class ColorOrModeConfigBasicSchema(Schema):
    ...
    temperature = fields.Integer(required=True,
                                 ...
                                 error_messages={'required': 'Temperature is a required field!',
                                                 ...
                                                 'validator_failed': 'Temperature must be a value between -1 and 255!'})
